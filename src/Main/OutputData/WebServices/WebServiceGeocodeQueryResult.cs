...
namespace USC.GISResearchLab.Geocoding.Core.OutputData.WebServices
{
    ...
    public class WebServiceGeocodeQueryResult
    {
        ...
        public string AsString_V04_05(string separator, double version)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(TransactionId).Append(separator); //0
            sb.Append(Version).Append(separator); //1
        ...
        public static string AsHeaderString_V04_05(string separator, double version)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
        ...
        public string AsStringWithCensus_V04_05(string separator, double version)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(TransactionId).Append(separator); //0
            sb.Append(Version).Append(separator); //1
                ...
                else // otherwise fill in the appropriate ones and blank out the rest
                {
                    ...
                    for (int i = 0; i < CensusRecords.Count; i++)
                    {
                        ...
                        if (censusOutputRecord.CensusYear == Census.Core.Configurations.ServerConfigurations.CensusYear.NineteenNinety)
                        {
                            ...
                            sb1990.Append(censusOutputRecord.CensusPlaceFips).Append(separator); //26
                            sb1990.Append(censusOutputRecord.CensusStateFips).Append(separator); //27
                            sb1990.Append(censusOutputRecord.GeoLocationID).Append(separator); //28
                            sb.Append(sb1990);
                        }
                        else if (censusOutputRecord.CensusYear == Census.Core.Configurations.ServerConfigurations.CensusYear.TwoThousand)
                        {
                            ...
                            sb2000.Append(censusOutputRecord.CensusPlaceFips).Append(separator); //26
                            sb2000.Append(censusOutputRecord.CensusStateFips).Append(separator); //27
                            sb2000.Append(censusOutputRecord.GeoLocationID).Append(separator); //28
                            sb.Append(sb2000);
                        }
                        else if (censusOutputRecord.CensusYear == Census.Core.Configurations.ServerConfigurations.CensusYear.TwoThousandTen)
                        {
                            ...
                            sb2010.Append(censusOutputRecord.CensusPlaceFips).Append(separator); //26
                            sb2010.Append(censusOutputRecord.CensusStateFips).Append(separator); //27
                            sb2010.Append(censusOutputRecord.GeoLocationID).Append(separator); //28
                            sb.Append(sb2010);
                        }
        ...
        public static string AsHeaderStringWithCensus_V04_01(string separator, double version, List<CensusYear> QueryCensusYears)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
        ...
        public static string AsHeaderStringWithCensus_V04_02(string separator, double version, List<CensusYear> QueryCensusYears)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
        ...
        public static string AsHeaderStringWithCensus_V04_05(string separator, double version)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
            ...
            sb.Append("Census1990PlaceFips").Append(separator); //26
            sb.Append("Census1990StateFips").Append(separator); //27
            sb.Append("GeoLocationID1990").Append(separator); //28

            sb.Append("Census2000Block").Append(separator); //29
            sb.Append("Census2000BlockGroup").Append(separator); //30
            sb.Append("Census2000Tract").Append(separator); //31
            sb.Append("Census2000CountyFips").Append(separator); //32
            sb.Append("Census2000CbsaFips").Append(separator); //33
            sb.Append("Census2000CbsaMicro").Append(separator); //34
            sb.Append("Census2000McdFips").Append(separator); //35
            sb.Append("Census2000MetDivFips").Append(separator); //36
            sb.Append("Census2000MsaFips").Append(separator); //37
            sb.Append("Census2000PlaceFips").Append(separator); //38
            sb.Append("Census2000StateFips").Append(separator); //39
            sb.Append("GeoLocationID2000").Append(separator); //40

            sb.Append("Census2010Block").Append(separator); //41
            sb.Append("Census2010BlockGroup").Append(separator); //42
            sb.Append("Census2010Tract").Append(separator); //43
            sb.Append("Census2010CountyFips").Append(separator); //44
            sb.Append("Census2010CbsaFips").Append(separator); //45
            sb.Append("Census2010CbsaMicro").Append(separator); //46
            sb.Append("Census2010McdFips").Append(separator); //47
            sb.Append("Census2010MetDivFips").Append(separator); //48
            sb.Append("Census2010MsaFips").Append(separator); //49
            sb.Append("Census2010PlaceFips").Append(separator); //50
            sb.Append("Census2010StateFips").Append(separator); //51
            sb.Append("GeoLocationID2010").Append(separator); //52

            //PAYTON:MicroMatchStatus -- this is for v4.03
            sb.Append("MicroMatchStatus").Append(separator); //53           
            //PAYTON:PENALTYCODE
            sb.Append("PenaltyCode").Append(separator); //54
            sb.Append("PenaltyCodeSummary"); //55
            return sb.ToString();
        }

        public static string AsHeaderStringWithCensus_V04_04(string separator, double version, List<CensusYear> QuerycensusYears)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
        ...
        public static string AsHeaderStringWithCensus_V04_05(string separator, double version, List<CensusYear> QuerycensusYears)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
            ...
            foreach (var year in QuerycensusYears)
            {
                switch (year.ToString())
                {
                    case "NineteenNinety":
                        ...
                        sb.Append("Census1990PlaceFips").Append(separator); //26
                        sb.Append("Census1990StateFips").Append(separator); //27
                        sb.Append("GeoLocationID1990").Append(separator); //27
                        break;
                    case "TwoThousand":
                        sb.Append("Census2000Block").Append(separator); //28
                        sb.Append("Census2000BlockGroup").Append(separator); //29
                        ...
                        sb.Append("Census2000PlaceFips").Append(separator); //37
                        sb.Append("Census2000StateFips").Append(separator); //38
                        sb.Append("GeoLocationID2000").Append(separator); //27
                        break;
                    case "TwoThousandTen":
                        sb.Append("Census2010Block").Append(separator); //39
                        sb.Append("Census2010BlockGroup").Append(separator); //40
                        ...
                        sb.Append("Census2010PlaceFips").Append(separator); //48
                        sb.Append("Census2010StateFips").Append(separator); //49
                        sb.Append("GeoLocationID2010").Append(separator); //27
                        break;
                    case "AllAvailable":
                        sb.Append("Census1990Block").Append(separator); //17
                        sb.Append("Census1990BlockGroup").Append(separator); //18
        ...
        public static string AsHeaderStringVerbose_V04_05(string separator, double version)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("TransactionId").Append(separator); //0
            sb.Append("Version").Append(separator); //1
